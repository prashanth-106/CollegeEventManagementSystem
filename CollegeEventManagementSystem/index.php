...
<body>
    ...
    <div class="content">
        <div class="container">
            <div class="col-md-12">
                <CENTER>
                    <h1 style="color:#0077B6 ; font-size:42px ; font-style:bold "><strong> Register your Favourite
                            events</strong></h1>
                </CENTER><!--body content title-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images\onstag.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
